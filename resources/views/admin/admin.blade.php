    ...
    <div class="col-md-4 ">
        ...
        <div class="content-top-1">
            ...
            <div class="col-md-6 top-content1">	   
                <div id="demo-pie-1" class="pie-title-center" data-percent="100"> <span class="pie-value"></span> </div>
            </div>
        ...
        <div class="content-top-1">
            ...
            <div class="col-md-6 top-content1">	   
                <div id="demo-pie-2" class="pie-title-center" data-percent="67"> <span class="pie-value"></span> </div>
            </div>
            <div class="clearfix"></div>
        </div>
        ...
        <div class="content-top-1">
            ...
            <div class="col-md-6 top-content1">	   
                <div id="demo-pie-3" class="pie-title-center" data-percent="33"> <span class="pie-value"></span> </div>
            </div>
            <div class="clearfix"> </div>
        </div>
    </div>
