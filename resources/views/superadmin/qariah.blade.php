        ...
        <div class="row">
            ...
            <div class="col-md-9">
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">Qariah List
                                <div class="pull-right">
                                        <a class="btn btn-sm btn-default" href="{{route('super.qariah_create')}}" role="button"><i class="fa fa-plus"></i> Add Qariah</a>
                                </div>
                        </div>
