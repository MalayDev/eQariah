                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group{{ $errors->has('fullname') ? ' has-error' : '' }}">
                                ...
                                {{Form::text('fullname', '', ['class' => 'form-control', 'placeholder' => 'Full Name', 'id' => 'fullname'])}}
                            ...
                            <div class="form-group{{ $errors->has('ic') ? ' has-error' : '' }}">
                                ...
                                {{Form::number('ic', '', ['class' => 'form-control', 'placeholder' => 'IC. Number', 'id' => 'ic'])}}
                            ...
                            <div class="form-group{{ $errors->has('age') ? ' has-error' : '' }}">
                                {{Form::label('age', 'Age')}}
                                {{Form::number('age', '', ['class' => 'form-control', 'placeholder' => 'Age', 'id' => 'age'])}}
                            ...
                            <div class="form-group{{ $errors->has('pnumber') ? ' has-error' : '' }}">
                                ...
                                {{Form::number('pnumber', '', ['class' => 'form-control', 'placeholder' => 'Phone Number', 'id' => 'pnumber'])}}
                            ...
                            <div class="form-group{{ $errors->has('hnumber') ? ' has-error' : '' }}">
                                ...
                                {{Form::number('hnumber', '', ['class' => 'form-control', 'placeholder' => 'Home Number', 'id'=> 'hnumber'])}}
                            ...
                            <div class="form-group{{ $errors->has('state') ? ' has-error' : '' }}">
                                ...
                                {{Form::select('state', ['Selangor' => 'Selangor'], null, ['class' => 'form-control', 'placeholder' => 'Select State...', 'id' => 'state'])}}
                            ...
                            <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                                ...
                                {{Form::select('city', ['Shah Alam' => 'Shah Alam'], null, ['class' => 'form-control', 'placeholder' => 'Select City...', 'id' => 'city'])}}
                            ...
                            <div class="form-group{{ $errors->has('rperiod') ? ' has-error' : '' }}">
                                ...
                                {{Form::text('rperiod', '', ['class' => 'form-control', 'placeholder' => 'Year + Month', 'id' => 'rperiod'])}}
                    ...
                    <div class="panel-heading">Part C: Qariah Verification</div>
                        <div class="panel-body">
                            <div class="form-group{{ $errors->has('nremarks') ? ' has-error' : '' }}">
                                ...
                                {{Form::textarea('nremarks', '', ['class' => 'form-control', 'placeholder' => 'Nazir Remarks...', 'id' => 'nremarks'])}}
                            ...
                            <div class="form-group{{ $errors->has('nazir_verify_date') ? ' has-error' : '' }}">
                                ...
                                {{Form::date('nazir_verify_date', \Carbon\Carbon::now(), ['class' => 'form-control', 'id' => 'nazir_verify_date'])}}
                            ...
                            <div class="form-group{{ $errors->has('hvremarks') ? ' has-error' : '' }}">
                                ...
                                {{Form::textarea('hvremarks', '', ['class' => 'form-control', 'placeholder' => 'Head Village Remarks...', 'id' => 'hvremarks'])}}
                            ...
                            <div class="form-group{{ $errors->has('hv_verify_date') ? ' has-error' : '' }}">
                                ...
                                {{Form::date('hv_verify_date', \Carbon\Carbon::now(), ['class' => 'form-control', 'id' => 'hv_verify_date'])}}
